...
const CreatorsDashboard = () => {
  ...
  return (
    <div
      className={cn(
        'min-h-[100dvh] flex  overflow-x-hidden items-start justify-start w-full font-sans',
        '!min-h-[100dvh]'
      )}
    >
      <div
        className={cn(
          'min-h-[100dvh] flex items-start  justify-start w-full max-w-[1200px] mx-auto ',
          '!min-h-[100dvh]'
        )}
      >
        <DashboardSideBar />
        <div className=' max-w-[1200px] w-full flex-1 mx-auto'>
          <div className='pt-10 md:pt-14 '>
            ...
            <div className=' px-10 md:px-16 mt-6 flex items-center gap-3'>
            ...
            <div className='px-10 md:px-16 mt-10 overflow-x-auto  hide-scrollbar'>
              <MetricsCard />
            </div>{' '}
            <div className='px-10 md:px-16 mt-10 overflow-x-auto  hide-scrollbar'>
              <CreatorVisitorChart />
